...
abstract class Media_Features_For_BuddyBoss_Plugins_Dependency {

    function __construct() {

        add_filter( 'media-features-for-buddyboss-load', array( $this, 'boilerplate_load' ) );
    ...
    public function get_plugin_name() {
        ...
        $plugin_data = get_plugin_data( MEDIA_FEATURES_FOR_BUDDYBOSS_FILES );
