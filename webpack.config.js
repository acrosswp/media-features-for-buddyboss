...
//// POT file.
wpPot( {
	package: 'Media Features For BuddyBoss',
	domain: 'media-features-for-buddyboss',
	destFile: 'languages/media-features-for-buddyboss.pot',
	relativeTo: './',
	src: [ './**/*.php' ],
	bugReport: 'https://github.com/acrosswp/media-features-for-buddyboss/issues'
} );
